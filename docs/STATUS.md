...
Drift is **pre-1.0** and source-first. This tree prepares source release `v0.2.0`, dated 30 August 2026. A changelog entry, build, CI artifact, pull request, local app, or disk image does not by itself make that release public.
...
| `v0.2.0` source release | Prepared by this tree | It is public only when the matching tag and GitHub Release exist. It contains no downloadable Mac binary. |
