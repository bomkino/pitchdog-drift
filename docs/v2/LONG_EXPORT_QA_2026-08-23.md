...
Final machine receipt: `output/qa/v2-long-export/2026-08-23T06-46-58.837Z/receipt.json` (ignored output, not source controlled).
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| 30s / 8 slides / 9:16 | 90×160 | 720 | 30s | 1,701,476 | 8 | 4 | 4,051ms |
| 60s / 40 slides / 16:9 | 160×90 | 1,440 | 60s | 2,212,131 | 24 | 4 | 5,464ms |
| 180s / 200 slides / 9:16 | 72×128 | 4,320 | 180s | 8,461,617 | 24 | 4 | 13,012ms |
...
After forced garbage collection, JS heap was 22,360,100 bytes before and 29,482,204 bytes after the full gate: a 7,122,104-byte delta inside the 33,554,432-byte allowance. Every physical engine also returned renderer textures and geometries to no more than its pre-export baseline after project unload. No context-loss or context-restoration event occurred.

The full headed test took 28.9 seconds; Playwright completed in 37.4 seconds. Typecheck and the focused pure matrix test also passed (8/8).
