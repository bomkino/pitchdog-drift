...
Until those gates hold, a local ad-hoc app or CI DMG remains a candidate—not a public download.

## Valuable contribution lanes

- Small, authored Film Worlds and portrait scenes with a motion sentence, legibility proof, and original/licensed assets.
- Renderer and shader performance work that preserves deterministic pixels and low idle cost.
- Project fuzzing, hostile archive cases, interrupted-write recovery, and bounded-memory export cases.
- Keyboard, VoiceOver, contrast, magnification, and motion-preview repairs tested by people on real Macs.
- Documentation that shortens a real contributor or creator journey and removes stale claims.
- Reproducible browser/runtime coverage beyond the currently verified Chrome and packaged WKWebView lanes.
...
- Silent codec, audio, alpha, recovery, or filesystem fallback.

Large schema changes, new native capabilities, dependencies, and public distribution work should begin with an issue because they change who bears risk. Small bugs with a synthetic reproduction are welcome directly.
