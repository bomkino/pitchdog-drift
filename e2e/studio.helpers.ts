...
export const LOCAL_REOPENED_NOTICE = "Local project reopened with verified Project V3 media.";
export const PORTABLE_OPENED_NOTICE = "Portable project verified, migrated when necessary, and copied into local Project V3 storage.";
export const PORTABLE_SAVED_NOTICE = "Portable Project V3 saved with original media and SHA-256 manifest.";
