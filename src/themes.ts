...
export const THEMES: ThemePreset[] = [
  makeTheme(
    ...
    "Measured vertical rhythm. Pages bank gently and hold their weight.",
    {
      motion: {
        axis: "vertical",
        direction: -1,
  ...
  makeTheme(
    ...
    "A wide arc with long momentum, paper curl, and a fading horizon.",
    {
      motion: {
        axis: "horizontal",
        direction: -1,
  ...
  makeTheme(
    ...
    "A slow tunnel climb. Elastic mass lags behind every uneasy change.",
    {
      motion: {
        axis: "vertical",
        direction: -1,
  ...
  makeTheme(
    ...
    "A disciplined contact sheet: direct response, rigid stock, no melodrama.",
    {
      motion: {
        axis: "horizontal",
        direction: 1,
  ...
  makeTheme(
    ...
    "Tender Light",
    "Romance · soft orbit",
    "Silk folds circle close to camera, luminous without becoming sugary.",
    {
      motion: {
        axis: "horizontal",
        direction: -1,
  ...
  makeTheme(
    ...
    "A fast spring helix with glossy depth and ultraviolet atmosphere.",
    {
      motion: {
        axis: "horizontal",
        direction: -1,
...
export function applyTheme(current: StudioSettings, theme: ThemePreset): StudioSettings {
  return {
    ...
    // is transparent. Preserve dimensions and user-owned presenter state.
    stage: {
