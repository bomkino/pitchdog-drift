...
export function assertAtmosphereAtlasIntegrity(): void {
  invariant(ATMOSPHERE_FAMILIES.length === ATMOSPHERE_FAMILY_COUNT, "atlas must contain nine families");
  ...
  invariant(compositions.length === ATMOSPHERE_COMPOSITION_COUNT, "atlas must contain seventy-two compositions");
