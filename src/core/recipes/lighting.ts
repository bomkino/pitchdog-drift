...
export const LIGHTING_RECIPES: readonly LightingRecipe[] = [
  rig(
    ...
    [],
    {
      ...
      artworkProtection: 1, heroProtection: 1, shadowOpacity: 0.34, shadowSoftness: 52,
  ...
  rig(
    ...
    ["long-shadow"],
    {
      ...
      artworkProtection: 1, heroProtection: 1, shadowOpacity: 0.48, shadowSoftness: 38,
  ...
  rig(
    ...
    ["flicker-with-held-poses"],
    {
      ...
      artworkProtection: 1, heroProtection: 1, shadowOpacity: 0.32, shadowSoftness: 72,
  ...
  rig(
    ...
    ["specular-pressure", "long-shadow", "low-artwork-protection"],
    {
      ...
      artworkProtection: 1, heroProtection: 1, shadowOpacity: 0.72, shadowSoftness: 18,
  ...
  rig(
    ...
    ["warm-colour-shift", "long-shadow"],
    {
      ...
      artworkProtection: 1, heroProtection: 1, shadowOpacity: 0.5, shadowSoftness: 58,
  ...
  rig(
    ...
    ["specular-pressure", "bloom-pressure"],
    {
      ...
      artworkProtection: 1, heroProtection: 1, shadowOpacity: 0.44, shadowSoftness: 46,
  ...
  rig(
    ...
    [],
    {
      ...
      artworkProtection: 1, heroProtection: 1, shadowOpacity: 0.18, shadowSoftness: 112,
  ...
  rig(
    ...
    ["cool-colour-shift"],
    {
      ...
      artworkProtection: 1, heroProtection: 1, shadowOpacity: 0.46, shadowSoftness: 82,
  ...
  rig(
    ...
    ["warm-colour-shift", "flicker-with-held-poses"],
    {
      ...
      artworkProtection: 1, heroProtection: 1, shadowOpacity: 0.58, shadowSoftness: 28,
  ...
  rig(
    ...
    ["flicker-with-held-poses", "card-bound-light"],
    {
      ...
      artworkProtection: 1, heroProtection: 1, shadowOpacity: 0.52, shadowSoftness: 48,
  ...
  rig(
    ...
    ["flicker-with-held-poses", "cool-colour-shift"],
    {
      ...
      artworkProtection: 1, heroProtection: 1, shadowOpacity: 0.24, shadowSoftness: 68,
  ...
  rig(
    ...
    ["long-shadow", "fast-light-motion", "low-artwork-protection"],
    {
      ...
      artworkProtection: 1, heroProtection: 1, shadowOpacity: 0.68, shadowSoftness: 24,
