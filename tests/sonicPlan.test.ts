...
describe("sonic timeline", () => {
  ...
  it("follows lateral direction while vertical passages stay centred", () => {
    const horizontal = cloneSettings(DEFAULT_SETTINGS);
    ...
    const vertical = cloneSettings(DEFAULT_SETTINGS);
