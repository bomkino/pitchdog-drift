...
final class NativeBoundaryTests:XCTestCase {
    func image(_ workspace:MediaWorkspace)throws->URL{
        ...
        let bytes=try XCTUnwrap(Data(base64Encoded:""));try bytes.write(to:file);return file
    }
